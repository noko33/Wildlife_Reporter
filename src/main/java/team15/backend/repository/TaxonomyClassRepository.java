...
import team15.backend.entity.TaxonomyClass;
 ...
 */
@Repository
public interface TaxonomyClassRepository extends JpaRepository<TaxonomyClass, Long> {
    ...
    */
    public Optional<TaxonomyClass> findByClassId(String classId); 
}